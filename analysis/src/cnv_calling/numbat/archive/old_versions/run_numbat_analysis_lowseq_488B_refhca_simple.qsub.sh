#!/bin/bash
################################################################################
# run_numbat_analysis_lowseq_488B_refhca_simple.qsub.sh
#
# PURPOSE: Run NUMBAT CNV analysis for lowseq_488B using ref_hca
#          Simplified version WITHOUT validation wrapper
#
################################################################################

#$ -N numbat_refhca_488B_simple
#$ -l h_rt=08:00:00
#$ -pe omp 8
#$ -P paxlab
#$ -l mem_per_core=8G
#$ -o analysis/qsub_logs/numbat_refhca_488B_simple_$JOB_ID.log
