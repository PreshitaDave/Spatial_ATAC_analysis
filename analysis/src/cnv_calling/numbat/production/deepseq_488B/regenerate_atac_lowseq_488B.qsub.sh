#!/bin/bash
#
# regenerate_atac_lowseq_488B.qsub.sh
# Purpose: Regenerate ATAC bin matrix for lowseq_488B using the CORRECT barcode file 
#          (the one used for pileup/allele counts)
#

#$ -N regenerate_atac_488B
#$ -l h_rt=04:00:00
#$ -pe omp 8
#$ -P paxlab
#$ -l mem_per_core=8G
#$ -o analysis/qsub_logs/regenerate_atac_488B_$JOB_ID.log
