...
#$ -P paxlab
#$ -l mem_per_core=8G
#$ -o /projectnb/paxlab/presh/projects/spatial_atac/analysis/qsub_logs/numbat_atac_489_.out
#$ -e /projectnb/paxlab/presh/projects/spatial_atac/analysis/qsub_logs/numbat_atac_489_.err
...
echo "[$(date +'%Y-%m-%d %H:%M:%S')] NUMBAT ATAC-bin mode: lowseq_489"
echo "[$(date +'%Y-%m-%d %H:%M:%S')] ════════════════════════════════════════════════════════════"
...
# Input files
COUNTMAT="$PROJECT_ROOT/Data/04_analysis/cnv/numbat/inputs/lowseq_489/atac_bin/lowseq_489_atac_bin.rds"
ALLELEDF="$PROJECT_ROOT/Data/04_analysis/cnv/numbat/inputs/lowseq_489/alleles/lowseq_489_atac_allele_counts.tsv.gz"
...
OUT_DIR="$PROJECT_ROOT/Data/04_analysis/cnv/numbat/results/lowseq_489/atac_only_run2"
