...
#$ -l mem_per_core=8G
#$ -l h_rt=48:00:00
#$ -o /projectnb/paxlab/presh/projects/spatial_atac/analysis/qsub_logs/numbat_dep.$JOB_ID.out
#$ -e /projectnb/paxlab/presh/projects/spatial_atac/analysis/qsub_logs/numbat_dep.$JOB_ID.err
#$ -j n
...
echo "[$(date '+%F %T')] START NUMBAT deepseq prep + ATAC-bin run"
...
echo "[$(date '+%F %T')] DONE NUMBAT deepseq"