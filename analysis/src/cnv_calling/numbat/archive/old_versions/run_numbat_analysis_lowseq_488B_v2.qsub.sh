#!/bin/bash
#
# run_numbat_analysis_lowseq_488B_v2.qsub.sh
# Purpose: NUMBAT refhca analysis for lowseq_488B (FIXED VERSION)
...
#$ -P paxlab
#$ -l mem_per_core=8G
#$ -o analysis/qsub_logs/numbat_488B_v2_$JOB_ID.log
...
echo "════════════════════════════════════════════════════════════════════════════"
echo "NUMBAT refhca Analysis: lowseq_488B (FIXED VERSION WITH CORRECT BARCODES)"
echo "════════════════════════════════════════════════════════════════════════════"
