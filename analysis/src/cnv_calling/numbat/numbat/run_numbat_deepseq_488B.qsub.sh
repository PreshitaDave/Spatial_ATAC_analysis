...
#$ -l mem_per_core=8G
#$ -l h_rt=48:00:00
#$ -o /projectnb/paxlab/presh/projects/spatial_atac/analysis/qsub_logs/numbat_deep_488B.$JOB_ID.out
#$ -e /projectnb/paxlab/presh/projects/spatial_atac/analysis/qsub_logs/numbat_deep_488B.$JOB_ID.err
#$ -j n
...
echo "[$(date '+%F %T')] START NUMBAT deepseq_488B prep + ATAC-bin run"
...
export OUT_DIR="/projectnb/paxlab/presh/projects/spatial_atac/Data/04_analysis/cnv/numbat/results/deepseq_488B/atac_only_run2"
...
echo "[$(date '+%F %T')] DONE NUMBAT deepseq_488B (atac_run2: 220kb bins)"
