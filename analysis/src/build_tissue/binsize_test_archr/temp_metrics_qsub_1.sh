...
#$ -P paxlab
#$ -l mem_per_core=8G
#$ -o /projectnb/paxlab/presh/projects/spatial_atac/analysis/qsub_logs/recompute_metrics_deepseq_488B_500_FALSE.log
#$ -e /projectnb/paxlab/presh/projects/spatial_atac/analysis/qsub_logs/recompute_metrics_deepseq_488B_500_FALSE.err
...
echo "[2026-06-22 11:48:06] [start] Recomputing metrics: deepseq_488B 500bp binarize=FALSE"
