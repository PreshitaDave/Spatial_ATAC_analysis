...
dend_colored <- color_branches(dend, k = 12)

plot(dend_colored, main = "Hierarchical Clustering Dendrogram (15 clusters)", ylab = "Height")
...
my_heatmap <-pheatmap(t(cnv_calls2), annotation_row = annotation, 
         show_rownames = FALSE, cluster_rows = hc, cluster_cols = FALSE, cutree_rows = 4,
         main = "Cell-by-Bin Heatmap, colored by 4 clusters",
...
save_pheatmap(my_heatmap, "/projectnb/paxlab/presh/Data/epianeufinder/cnv_clust_pheatmap.png")
dev.off()
```
