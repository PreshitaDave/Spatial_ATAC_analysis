#!/bin/bash
#$ -cwd
#$ -N numbat_prep_lowseq_488B
#$ -l h_rt=08:00:00
#$ -l mem_per_core=8G
#$ -pe omp 8
#$ -P paxlab
#$ -o analysis/qsub_logs/numbat_prep_lowseq_488B.$JOB_ID.out
#$ -e analysis/qsub_logs/numbat_prep_lowseq_488B.$JOB_ID.err

################################################################################
# SGE Wrapper: Prepare NUMBAT inputs for lowseq tissue 488B
# 
# Generates:
...
echo "==============================================="
echo "NUMBAT Input Preparation: lowseq 488B"
echo "==============================================="
echo "Job ID: $JOB_ID"
echo "Host: $(hostname)"
...
echo "[STEP 2] Running input preparation (lowseq 488B)..."
