#!/bin/bash
#
# run_numbat_multiome_lowseq_488B.qsub.sh
# Purpose: NUMBAT CNV analysis for lowseq_488B using multiome script
# Uses: run_numbat_multiome.R with command-line arguments
#

#$ -N numbat_multiome_488B
#$ -l h_rt=08:00:00
#$ -pe omp 8
#$ -P paxlab
#$ -l mem_per_core=8G
#$ -o analysis/qsub_logs/numbat_multiome_488B_$JOB_ID.log
...
echo "════════════════════════════════════════════════════════════════════════════"
echo "NUMBAT multiome Analysis: lowseq_488B (Command-line argument mode)"
echo "════════════════════════════════════════════════════════════════════════════"
