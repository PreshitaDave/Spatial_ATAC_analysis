#!/bin/bash
################################################################################
# run_numbat_analysis_lowseq_489_refhca_newrun.qsub.sh
#
# PURPOSE: Run NUMBAT CNV analysis for lowseq_489 using ref_hca (new run)
...
#
# OUTPUTS:
#   - CNV results to Data/04_analysis/cnv/numbat/results/lowseq_489/refhca_run_20260519/
#
################################################################################

#$ -N numbat_refhca_lowseq_489
#$ -l h_rt=08:00:00
#$ -pe omp 8
#$ -P paxlab
#$ -l mem_per_core=8G
#$ -o analysis/qsub_logs/numbat_refhca_lowseq_489_$JOB_ID.log
