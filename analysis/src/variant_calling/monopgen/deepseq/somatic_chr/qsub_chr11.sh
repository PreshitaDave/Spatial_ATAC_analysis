...
#$ -l mem_per_core=8G
#$ -pe omp 8
#$ -o /projectnb/paxlab/presh/projects/spatial_atac/analysis/src/variant_calling/monopgen/deepseq/somatic_chr/qsub_logs_deep/chr11.log
#$ -e /projectnb/paxlab/presh/projects/spatial_atac/analysis/src/variant_calling/monopgen/deepseq/somatic_chr/qsub_logs_deep/chr11.error.log
