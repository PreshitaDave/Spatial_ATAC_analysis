#!/bin/bash -l
#$ -P paxlab
#$ -N calicost_deepseq_488B
#$ -wd /projectnb/paxlab/presh/projects/spatial_atac
#$ -pe omp 8
#$ -l mem_per_core=8G
#$ -l h_rt=48:00:00
#$ -j y
#$ -o /projectnb/paxlab/presh/projects/spatial_atac/analysis/qsub_logs/calicost_deepseq_488B_$JOB_ID.log
#$ -m bea
#$ -M preshita@bu.edu
...
if [ ! -f "${ALLELE_FILE}" ]; then
    echo "ERROR: Allele counts not found: ${ALLELE_FILE}"
    echo "Run the pileup job first: tissue/deepseq_488B/run_pileup_deepseq_488B.qsub.sh"
    exit 1
fi
