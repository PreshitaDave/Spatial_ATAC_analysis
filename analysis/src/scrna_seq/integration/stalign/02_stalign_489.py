...
"""
02_stalign_489.py
STAlign / PASTE2: RNA-guided spatial re-alignment for tissue 489 (lowseq_489).
Same workflow as 02_stalign_488B.py. See that file for method details.

Prerequisites: 00_export_for_stalign.R (489 mode) must have been run first.
"""
