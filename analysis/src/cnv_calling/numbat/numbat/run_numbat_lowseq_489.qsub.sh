...
echo "[$(date '+%F %T')] START NUMBAT lowseq_489 prep + ATAC-bin run"
...
export OUT_DIR="/projectnb/paxlab/presh/projects/spatial_atac/Data/04_analysis/cnv/numbat/results/lowseq_489/atac_only_run2"
...
echo "[$(date '+%F %T')] DONE NUMBAT lowseq_489 (atac_run2: 220kb bins)"
